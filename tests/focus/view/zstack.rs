...
fn skips_unfocusable_back_layer() {
    let state = State { a: 0, b: 0, c: 0 };
    let mut harness =
        FocusTestHarness::new(stack_with_unfocusable_back, state, Size::new(100, 100))
            .with_roles(Role::Button);
...
fn skips_unfocusable_middle_layer() {
    let state = State { a: 0, b: 0, c: 0 };
    let mut harness =
        FocusTestHarness::new(stack_with_unfocusable_middle, state, Size::new(100, 100))
            .with_roles(Role::Button);
...
fn skips_unfocusable_front_layer() {
    let state = State { a: 0, b: 0, c: 0 };
    let mut harness =
        FocusTestHarness::new(stack_with_unfocusable_front, state, Size::new(100, 100))
            .with_roles(Role::Button);
...
fn nested_zstack_forward_navigation() {
    let state = State { a: 0, b: 0, c: 0 };
    let mut harness =
        FocusTestHarness::new(nested_zstack, state, Size::new(100, 100)).with_roles(Role::Button);
...
fn single_item_focus() {
    let state = State { a: 0, b: 0, c: 0 };
    let mut harness = FocusTestHarness::new(single_item_stack, state, Size::new(100, 100))
        .with_roles(Role::Button);
